        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Cable 2.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Cable de cobre tipo THW-LS/THHW-LS 600V 75°C/90°C Deslizable, Antiflama</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    Cable THW-LS de cobre suave electrolítico con aislamiento de policloruro de vinilo (PVC).
                    </Text>
                </View>
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['2','4','6','8','10','12','14','1/0','2/0','3/0','4/0'].map(caliber => (
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['Amarillo','Azul','Blanco','Negro','Rojo','Verde'].map(color => (
