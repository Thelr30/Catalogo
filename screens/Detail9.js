        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Cable 7.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Cordones y cables flexibles PVC 600V 60°C</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    Cordones y cables flexibles formados por dos o tres conductores de cobre suave en construcción flexible, con aislamiento individual de policloruro de vinilo (PVC) identificados por colores y cubierta exterior de policloruro de vinilo (PVC) en color naranja.
                    </Text>
                </View>
