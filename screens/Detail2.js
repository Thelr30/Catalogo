        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Alambre 2.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Alambre Dúplex tipo TWD Autoextinguible 600V 60°</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    Alambre duplex​ de cobre suave con aislamiento de policloruro de vinilo (PVC), dispuestos en paralelo, unidos por una pista del mismo material.
                    </Text>
                </View>
