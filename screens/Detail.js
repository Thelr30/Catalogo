        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Alambre 1.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Alambre de cobre tipo THW-LS/THHW-LS 600V 75°C/90°C Deslizable, Antiflama</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    <Text style={styles.textDescription}>
                        El cable de cobre calibre 12 es un conductor de cobre suave electrolítico con aislamiento de PVC, diseñado para aplicaciones que requieren alta seguridad y facilidad de instalación. Cuenta con propiedades antiflama y baja emisión de humos, ideal para ductos y canalizaciones residenciales, comerciales e industriales.
                    </Text>
                </View>
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['Blanco','Negro','Rojo','Verde'].map(color => (
