        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Cable 5.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Cable uso rudo 2×10 tipo PVC 600V 60°C</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    El cable uso rudo 2×10 está formado por dos conductores de cobre suave en una construcción flexible, con aislamiento individual de policloruro de vinilo (PVC) identificados por colores. Su cubierta exterior de PVC negro con traza de color facilita la identificación y es resistente a los rayos UV, ideal para aplicaciones exigentes que requieren seguridad y durabilidad.
                    </Text>
                </View>
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['2x10','2x12','2x14','2x16','2x18','3x10','3x12','3x14','3x16','3x18','4x10','4x12','4x14','4x16'].map(caliber => (
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['Amarillo','Azul','Rosa','Verde','Rojo'].map(color => (
