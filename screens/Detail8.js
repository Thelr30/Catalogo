        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={{ height: 400 }}>
                    <ImageBackground source={require('../assets/Cable 6.jpg')} resizeMode="cover" style={{ height: 400 }} />
                </View>

                <View style={styles.containerTitle}>
                    <Text style={styles.textTitle}>Cordón flexible Naranja Uso Rudo tipo SJT, 300V 60°C</Text>
                </View>
                ...
                <View style={{ marginTop: 40, marginBottom: 40, paddingHorizontal: 20 }}>
                    ...
                    Cable de uso rudo 3×12 y otros calibres formado por dos o tres conductores de cobre suave en construcción flexible, con aislamiento individual de policloruro de vinilo (PVC) identificados por colores y cubierta exterior de policloruro de vinilo (PVC) en color naranja.
                    </Text>
                </View>
                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.optionsContainer}>
                        {['12','14','2x12','2x14','3x12','3x14',].map(caliber => (
